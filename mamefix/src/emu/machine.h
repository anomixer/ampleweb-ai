...
public:
	...
	static uint8_t emscripten_read_ram(uint32_t addr);
	static uint32_t emscripten_read_ram_bulk(uint32_t start_addr, uint32_t length, uint8_t *out_buf);
	static uint8_t emscripten_read_machine_ram(const char* share_name, uint32_t addr);
	static uint32_t emscripten_read_machine_ram_bulk(const char* share_name, uint32_t addr, uint32_t length, uint8_t *out_buf);
	static uint8_t emscripten_read_main_ram(uint32_t addr);
	static uint32_t emscripten_read_main_ram_bulk(uint32_t start_addr, uint32_t length, uint8_t *out_buf);
	static uint8_t emscripten_read_aux_ram(uint32_t addr);
	static uint32_t emscripten_read_aux_ram_bulk(uint32_t start_addr, uint32_t length, uint8_t *out_buf);
#endif
};
