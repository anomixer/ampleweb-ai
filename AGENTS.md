...
- **[AmpleWeb] Premium Drawer-Style Collapsible Layout Overhaul (SuperA'Can Web Style)**:
    ...
    - **Responsive Design**: On mobile screens (<= 800px), both sidebars are smoothly hidden entirely when collapsed to prevent layout distortion, keeping full touch-friendly vertical responsiveness.
